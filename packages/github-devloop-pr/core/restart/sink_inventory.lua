...
add("comment:pr:reconcile-blocked", "reconcile", "emit_blocked_reconcile.pr_comment", "comment", "lifecycle-authoritative", "state:v1/blocked+review-reconcile|fix-reconcile:v1")

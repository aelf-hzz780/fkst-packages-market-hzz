...
local function assert_fix_shadow_case(fixture)
  ...
  t.eq(shadow.incoming_version, incoming_version, fixture.name .. ": decision incoming version is byte-exact")
  t.eq(shadow.target_version, target_version, fixture.name .. ": decision target version is byte-exact")
  t.eq(shadow.overlay_version, overlay_version, fixture.name .. ": decision overlay version is byte-exact")

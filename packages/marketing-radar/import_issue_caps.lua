...
return {
  ...
  inspect_rc2_proposal = core.inspect_rc2_proposal,
  latest_proposal = core.latest_proposal,
  next_proposal_revision = core.next_proposal_revision,
  normalized_login = core.normalized_login,
  parse_control_fields = core.parse_control_fields,
  parse_proposal = core.parse_proposal,
  proposal_catalog_group = core.proposal_catalog_group,
  proposal_create_provenance = core.proposal_create_provenance,
  proposal_group_key = core.proposal_group_key,
  proposal_rc2_group_key = core.proposal_rc2_group_key,
  ...
  review_failure_status = core.review_failure_status,

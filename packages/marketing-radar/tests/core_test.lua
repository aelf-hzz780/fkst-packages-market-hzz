...
mode: shadow
    ...
    t.eq(fields["source-url"], "https://github.com/aelf-hzz780/fkst-packages-market-hzz/issues/24")
    t.eq(fields.assignee, "aelf-hzz780")
  end,
...
timezone: Asia/Shanghai
    ...
    t.eq(classified.account, "hzz780")
...
assignee: aelf-hzz780
    ...
    t.eq(request.assignees[1], "aelf-hzz780")

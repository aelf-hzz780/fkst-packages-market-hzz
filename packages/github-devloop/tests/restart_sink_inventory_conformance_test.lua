...
local semantic_specs = {
  ...
  { "label:issue:awaiting-pr-state", "observe_issue", "awaiting_pr_replayer.grant_facade_label", "label", "lifecycle-authoritative", "state-label:awaiting-pr;dedup=awaiting-pr/label", "packages/github-devloop/core/restart_effect_facade.lua", { "serialize_awaiting_pr_label", "\"label:issue:awaiting-pr-state\"" } },
  { "comment:issue:awaiting-pr-terminal", "observe_issue", "awaiting_pr_replayer.grant_facade_exit_comment", "comment", "lifecycle-authoritative", "state:v1/merged|ready|blocked;dedup=awaiting-pr/resume", "packages/github-devloop/core/restart_effect_facade.lua", { "serialize_awaiting_pr_exit_comment", "\"comment:issue:awaiting-pr-terminal\"" } },
  { "label:issue:awaiting-pr-terminal", "observe_issue", "awaiting_pr_replayer.grant_facade_exit_label", "label", "lifecycle-authoritative", "state-label:merged|ready|blocked;dedup=awaiting-pr/label", "packages/github-devloop/core/restart_effect_facade.lua", { "serialize_awaiting_pr_exit_label", "\"label:issue:awaiting-pr-terminal\"" } },
  ...
  { "comment:issue:converge-round", "loop", "act.grant_facade_comment", "comment", "lifecycle-authoritative", "converge-round:v1;dedup=converge-round/comment", "packages/github-devloop/core/restart_effect_facade.lua", { "serialize_loop_plain_comment", "build_converge_round_comment_request", "comment:issue:converge-round" } },
  ...
  { "comment:issue:thinking-state", "observe_issue", "entry_writer.grant_facade_comment", "comment", "lifecycle-authoritative", "state:v1/thinking;dedup=proposal/comment/thinking", "packages/github-devloop/core/restart_effect_facade.lua", { "serialize_thinking_comment", "build_observe_comment_request", "comment:issue:thinking-state" } },
  { "label:issue:thinking-state", "observe_issue", "entry_writer.grant_facade_label", "label", "lifecycle-authoritative", "state-label:thinking;dedup=proposal/label/thinking", "packages/github-devloop/core/restart_effect_facade.lua", { "serialize_thinking_label", "build_thinking_label_request", "label:issue:thinking-state" } },

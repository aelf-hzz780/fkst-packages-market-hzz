...
local semantic_specs = {
  ...
  { "label:issue:timeout-reconcile", "reconcile", "pipeline_timeout.label", "label", "lifecycle-authoritative", "state-label:blocked;dedup=timeout-reconcile/label", "packages/github-devloop/departments/reconcile/main.lua", { "pipeline_timeout", "build_state_label_request" } },

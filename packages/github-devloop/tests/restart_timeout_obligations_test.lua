...
return {
  test_timeout_obligations_link_expected_decisions_and_payloads_to_frozen_parity = function()
    ...
    for _, obligation in ipairs(obligations) do
      ...
      t.eq(obligation.case_kind, "timeout", obligation.obligation_id .. ": case kind")
      t.eq(

...
return {
  ...
  test_issue_owner_derives_compatible_ordered_typed_edge_pair_obligations = function()
    local edges = canonical_edges()
  ...
  test_issue_owner_reports_edge_pair_with_missing_member_witness_as_unmapped = function()
    local edges = canonical_edges()
    local pairs = compatible_edge_pairs(edges)

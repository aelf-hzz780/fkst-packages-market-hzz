...
local sinks_by_id = {}
for _, sink in ipairs(require("core.restart.sink_inventory")) do
...
function M.mint_grant(sealed_snapshot, decision_result, sink_id)
...
function M.verify_grant(grant, expected_effect_id, expected_snapshot)
